set_property SRC_FILE_INFO {cfile:C:/Users/yjc/OneDrive/Desktop/csprojects/cpu/Computer_Organization_Project/project_cpu/project_cpu.srcs/sources_1/ip/clock_cpu/clock_cpu.xdc rfile:../../project_cpu.srcs/sources_1/ip/clock_cpu/clock_cpu.xdc id:1 order:EARLY scoped_inst:ucpuclk/inst} [current_design]
set_property src_info {type:PI file:{} line:-1 export:NONE save:INPUT read:READ} [current_design]
set_property TOOL_DERIVED_CLK_NAMES 1:0:CLKIN1:CLKFBOUT:ucpuclk/inst/clk_in1:clkfbout_clk_wiz_0::1:0:CLKIN1:CLKOUT0:ucpuclk/inst/clk_in1:clk_out1_clk_wiz_0 [get_cells ucpuclk/inst/plle2_adv_inst]
