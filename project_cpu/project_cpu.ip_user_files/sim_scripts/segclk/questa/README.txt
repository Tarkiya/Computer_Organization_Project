...
#
# Generated by export_simulation on Thu May 30 15:25:58 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './segclk.sh' script.
...
./segclk.sh -noclean_files

For more information on the script, please type './segclk.sh -help'.
