...
#
# Generated by export_simulation on Sat Jun 01 23:39:08 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './clock_cpu.sh' script.

./clock_cpu.sh -reset_run
...
./clock_cpu.sh -noclean_files

For more information on the script, please type './clock_cpu.sh -help'.
